...
public class RegistrationPageResource {
    ...
    public Response post(
        ...
        switch (submitButtonValue) {
            ...
            case Register: {
                try {
                    idpUserService.attachIdpUserToSession(idpName, firstname, surname, addressLine1, addressLine2, addressTown, addressPostCode, levelOfAssurance, dateOfBirth, username, password, sessionCookie);
