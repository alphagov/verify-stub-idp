...
public class StubIdpAppRule extends DropwizardAppRule<StubIdpConfiguration> {
    ...
    public static ConfigOverride[] withDefaultOverrides(ConfigOverride ... configOverrides) {
        ImmutableList<ConfigOverride> overrides = ImmutableList.<ConfigOverride>builder()
                ...
                .add(ConfigOverride.config("metadata.trustStore.path", trustStore.getAbsolutePath()))
                ...
                .add(ConfigOverride.config("europeanIdentity.metadata.trustStore.path", trustStore.getAbsolutePath()))
                ...
                .add(ConfigOverride.config("signingKeyPairConfiguration.cert", STUB_IDP_PUBLIC_PRIMARY_CERT))
                .add(configOverrides)
                .build();
