...
public class NonSuccessAuthnResponseServiceTest {
    ...
    public void shouldBuildAuthnPending(){
        nonSuccessAuthnResponseService.generateAuthnPending(IDP_NAME, REQUEST_ID, RELAY_STATE);
    ...
    public void shouldBuildNoAuthnContext(){
        nonSuccessAuthnResponseService.generateNoAuthnContext(IDP_NAME, REQUEST_ID, RELAY_STATE);
    ...
    public void shouldBuildUpliftFailed(){
        nonSuccessAuthnResponseService.generateUpliftFailed(IDP_NAME, REQUEST_ID, RELAY_STATE);
    ...
    public void shouldBuildNoAuthnCancel(){
        nonSuccessAuthnResponseService.generateAuthnCancel(IDP_NAME, REQUEST_ID, RELAY_STATE);
    ...
    public void shouldBuildNoAuthnFailed(){
        nonSuccessAuthnResponseService.generateAuthnFailed(IDP_NAME, REQUEST_ID, RELAY_STATE);
    ...
    public void shouldBuildRequesterError(){
        nonSuccessAuthnResponseService.generateRequesterError(REQUEST_ID, "error", IDP_NAME, RELAY_STATE);
    ...
    public void shouldBuildFraudResponse(){
        ...
        nonSuccessAuthnResponseService.generateFraudResponse(IDP_NAME, REQUEST_ID, FraudIndicator.FI01, "ipAddress", session);
