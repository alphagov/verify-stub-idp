...
public class JDBIEidasSessionRepositoryTest {
	...
	public void createSession_shouldCreateEidasSessionAndStoreInDatabase() {
		...
		session.setEidasUser(new EidasUser("Joe", "Bloggs", "persistentId", new LocalDate(1524655440000L, DateTimeZone.UTC), Optional.of(new EidasAddress("PO Box 123", "", "", "", "", "", "", "", "AB1 2YZ")), Optional.of(Gender.MALE)));
	...
	public void get_shouldReturnPopulatedEidasSession_whenSessionExists() {
		...
		expectedSession.setEidasUser(new EidasUser("Joe", "Bloggs", "persistentId", new LocalDate(1524655440000L, DateTimeZone.UTC), Optional.of(new EidasAddress("PO Box 123", "", "", "", "", "", "", "", "AB1 2YZ")), Optional.of(Gender.MALE)));
